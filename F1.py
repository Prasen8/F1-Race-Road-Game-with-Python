...
def high_score_update(dodged):
	high_scores = open('C:/Users/Prasen/OneDrive/Desktop/Game.python/F1 Car Racing/textfile/high_score.txt', 'w')
	temperd = str(dodged)
...
def looping_gameplay():
	...
	highest_score_txtfile = open('C:/Users/Prasen/OneDrive/Desktop/Game.python/F1 Car Racing/textfile/high_score.txt','r')
